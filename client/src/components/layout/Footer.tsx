    ...
    <footer className="bg-neutral-800 text-white pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">{t("common.about_blinkeach")}</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4">{t("common.customer_service")}</h3>
            <ul className="space-y-2 text-neutral-400 text-sm">
              <li>
                <Link href="/profile">
                  <span className="hover:text-white transition-colors cursor-pointer">
          ...
          <div>
            ...
            <h3 className="text-lg font-semibold mt-6 mb-3">{t("checkout.payment_methods")}</h3>
