  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={contactMutation.isPending}>
                  {contactMutation.isPending ? "Sending..." : t("common.submit")}
                </Button>
              </form>
            </CardContent>
      ...
      <div className="bg-muted p-6 rounded-lg">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-medium">{t("contact.faq_business_hours_question")}</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            <h3 className="font-medium">{t("contact.faq_track_order_question")}</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div>
            <h3 className="font-medium">{t("contact.faq_return_policy_question")}</h3>
            <p className="text-sm text-muted-foreground">
