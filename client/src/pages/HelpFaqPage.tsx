          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="shipping-cost">
              ...
              <AccordionContent>
                ...
                <ul className="list-disc pl-5 mt-2">
                  <li>
                    Standard delivery charge: ₹40 applies to all orders across India
                  </li>
                  <li>
                  ...
                  <li>
                    Express delivery options may have additional charges based on location
                  </li>
                  <li>
                    Special handling charges may apply for oversized or fragile items
                  </li>
                </ul>
                The complete pricing breakdown including delivery charges, discounts, and GST will be displayed at checkout before payment.
              </AccordionContent>
            </AccordionItem>
