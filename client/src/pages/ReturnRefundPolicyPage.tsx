...
const ReturnRefundPolicyPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold mb-6">{t("legal.return_refund.title")}</h1>
      ...
      <div className="prose max-w-none">
        ...
        <p>
          {t("legal.return_refund.introduction")}
        </p>
        ...
        <p>
          Most products can be returned within 7 days of delivery, provided
