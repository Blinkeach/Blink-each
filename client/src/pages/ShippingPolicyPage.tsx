  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Helmet>
        ...
        <meta
          name="description"
          content={t("legal.shipping.introduction")}
        />
      </Helmet>
      ...
      <div className="prose max-w-none">
        ...
        <ul>
          <li>
            <strong>Standard Delivery Charge:</strong> ₹40 applies to all orders across India.
          </li>
          <li>
            <strong>Free Delivery:</strong> Available on orders above ₹499 - delivery charge waived automatically.
          </li>
          <li>
            <strong>GST Inclusive:</strong> All prices include 18% GST as per government regulations.
          </li>
          <li>
            <strong>Express Shipping:</strong> Additional charges may apply for same-day or next-day delivery based on location.
          </li>
          <li>
            <strong>Special Products:</strong> Oversized, heavy, or fragile items may incur additional handling charges.
          </li>
        </ul>
